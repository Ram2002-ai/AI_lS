...
def spilt_documents(docs,chunk_size=1000,chunk_overlap=150):
...
# ================== Explicity traced load/build runs ==================
...
def build_index_run(pdf_path:str,index_dir:Path,chunk_size:int,chunk_overlap:int,embed_model_name:str):
    ...
    splits=spilt_documents(docs,chunk_size=chunk_size,chunk_overlap=chunk_overlap) #child
